...
var os = null;
var systemSelector = document.getElementById("sysSelector").querySelectorAll("a");
...
function detectOS() {
    if (navigator.appVersion.indexOf("Win") != -1) osName = "Windows", os = "win";
    if (navigator.appVersion.indexOf("Mac") != -1) osName = "MacOS", os = "mac";
    //   if (navigator.appVersion.indexOf("X11") != -1)
    //     (osName = "UNIX"), (os = "unix");
    //   if (navigator.appVersion.indexOf("Linux") != -1)
    //     (osName = "Linux"), (os = "lin");
    document.getElementById("sys").innerHTML = osName;
    if (os != null) document.getElementById("sysSelector").querySelectorAll("a").forEach((button)=>{
...
function selectOS(button) {
    ...
    var config = new _bootstrap.Tab(document.querySelector('#configurator a[href="#list-config"]'));
    config.show();
}
function resetOS() {
    systemSelector.forEach((button)=>{
...
function generate(mID, mPass) {
    ...
    var install = new _bootstrap.Tab(document.querySelector('#configurator a[href="#list-install"]'));
    install.show();
}
function download() {
    var filename = "pleaseRenameMe.inetloc";
    var xmltext = "<?xml version='1.0' encoding='UTF-8'?><!DOCTYPE plist PUBLIC '-//Apple//DTD PLIST 1.0//EN' 'http://www.apple.com/DTDs/PropertyList-1.0.dtd'><plist version='1.0'><dict><key>URL</key><string>" + urlDownload + "</string></dict></plist>";
    if (os == "win") {
...
},{"./instanceOf.js":"5XVaZ","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"44CRG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _instanceOfJs = require("./instanceOf.js");
...
},{"../enums.js":"kBo2A","../dom-utils/getOffsetParent.js":"h282o","../dom-utils/getWindow.js":"MkPcb","../dom-utils/getDocumentElement.js":"jaH6y","../dom-utils/getComputedStyle.js":"cn2q5","../utils/getBasePlacement.js":"uyzYw","../utils/math.js":"gyDDZ","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"gK2qK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./getBasePlacement.js":"uyzYw","./getVariation.js":"e7Opv","./getMainAxisFromPlacement.js":"3RRs0","../enums.js":"kBo2A","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"e7Opv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"5gagL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _getVariationJs = require("./getVariation.js");
var _getVariationJsDefault = parcelHelpers.interopDefault(_getVariationJs);
...
},{"./createPopper.js":"eWRl5","./modifiers/eventListeners.js":"gK2qK","./modifiers/popperOffsets.js":"767Ci","./modifiers/computeStyles.js":"eNeWb","./modifiers/applyStyles.js":"iCp47","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["8Ye98","6cF5V"], "6cF5V", "parcelRequire82fc")
